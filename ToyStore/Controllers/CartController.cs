...
namespace SourceCode.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult AddOrder(User user, int NumberDiscountPass = 0, string CodePass = "", string payment = "")
        {
            ...
            SentMail("Đặt hàng thành công", user.Email, "huynhanhvu7749@gmail.com", "jrdkxkiekvcnkcbl", "<p style=\"font-size:20px\">Cảm ơn bạn đã đặt hàng<br/>Mã đơn hàng của bạn là: " + order.ID);
